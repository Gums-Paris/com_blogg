...
class CommentsModel extends ListModel
{
	...
	*/
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				...
				'comment_update', 'a.comment_update',
				'comment_ip', 'a.comment_ip',
				'comment_hit', 'a.comment_hit',
				'comment_title', 'a.comment_title',
				'comment_desc', 'a.comment_desc',
				'comment_gallery', 'a.comment_gallery',
				'comment_gallery_text', 'a.comment_gallery_text',
			);
		}
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__blogg_comments` AS a');
