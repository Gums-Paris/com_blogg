	...
	public function publish()
	{
		...
		if ($user->authorise('core.edit', 'com_blogg') || $user->authorise('core.edit.state', 'com_blogg'))
		{
			...
			if (!$item)
			{
				...
				$this->setRedirect(Route::_('index.php?option=com_blogg&view=posts', false));
			}
			else
			{
	...
	public function checkin()
	{
		...
		if ($user->authorise('core.manage', 'com_blogg') || $item->checked_out == $user->id) { 
			...
			if ($return === false)
			{
				...
				$this->setRedirect(Route::_('index.php?option=com_blogg&view=post' . '&id=' . $id, false), $message, 'error');
				return false;
			}
			else
			{
				...
				$this->setRedirect(Route::_('index.php?option=com_blogg&view=post' . '&id=' . $id, false), $message);
				return true;
			}
		}
		else
	...
	public function remove()
	{
		...
		if ($user->authorise('core.delete', 'com_blogg'))
		{
			...
			else
			{
				...
				$this->app->redirect(Route::_('index.php?option=com_blogg&view=posts', false));
			}
