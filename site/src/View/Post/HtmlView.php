...
namespace Blogg\Component\Blogg\Site\View\Post;
// No direct access
	...
	protected function _prepareDocument()
	{
		...
		if ($this->params->get('robots'))
		{
            ...
            $pathway = $app->getPathway();
                        $breadcrumbList = Text::_('COM_BLOGG_TITLE_POSTS');
            
                        if(!in_array($breadcrumbList, $pathway->getPathwayNames())) {
                            $pathway->addItem($breadcrumbList, "index.php?option=com_blogg&view=posts");
                        }
                        $breadcrumbTitle = Text::_('COM_BLOGG_TITLE_POST');
