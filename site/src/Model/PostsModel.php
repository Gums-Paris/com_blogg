...
/**
 * Methods supporting a list of Blogg records.
 *
 * @since  1.0.0
 */
class PostsModel extends ListModel
{
	...
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				...
				'post_update', 'a.post_update',
				'post_ip', 'a.post_ip',
				'post_hits', 'a.post_hits',
				'post_title', 'a.post_title',
				'post_desc', 'a.post_desc',
				'post_image', 'a.post_image',
				'ext_gallery', 'a.ext_gallery',
				'ext_gallery_text', 'a.ext_gallery_text',
			);
		}
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		parent::populateState('a.post_date', 'DESC');
		...
		$ordering  = $this->getUserStateFromRequest($this->context .'.filter_order', 'filter_order', 'a.post_date');
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(Text::_("COM_BLOGG_SEARCH_FILTER_DATE_FORMAT"), "warning");
