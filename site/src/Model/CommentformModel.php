 ...
 * @since  1.0.0
 */
class CommentformModel extends FormModel
{
	private $item = null;
	...
	protected function populateState()
	{
		...
		{
			$id = Factory::getApplication()->getUserState('com_blogg.edit.comment.id');
		}
		else
		{
			$id = Factory::getApplication()->input->get('id');
			Factory::getApplication()->setUserState('com_blogg.edit.comment.id', $id);
		}
	 ...
	 */
	public function getTable($type = 'Comment', $prefix = 'Administrator', $config = array())
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_blogg.comment', 'commentform', array(
						'control'   => 'jform',
						'load_data' => $loadData
				)
		);
	...
	{
		$data = Factory::getApplication()->getUserState('com_blogg.edit.comment.data', array());
